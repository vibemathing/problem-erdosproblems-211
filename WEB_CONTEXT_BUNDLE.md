...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:erdosproblems-211",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "erdosproblems:211",
    ...
    "statement": {
      "language": "en",
      "text": "Draft bounty intake target(s): Erdős Problem #211. The exact mathematical statement, quantifiers, definitions, assumptions, and acceptance conditions have not yet been frozen; this draft is not research-admitted.",
      "version": 1
    },
    "title": "Erdős Problem #211",
    "updated_at": "2026-09-08T08:24:29Z"
  },
  "problem_contract_sha256": "d36ab6e7ccdd129ce2845880bc7b13ffbde734deb69e61a9d5c33e8e3d1c7e6b"
}
```
